...
$type = ($_POST["type"] == 1) ? "-1" : "+1";
	...
	$db->Query("SELECT *, INET_NTOA(db_users_a.ip) uip FROM db_users_a, db_users_b WHERE db_users_a.id = db_users_b.id AND db_users_b.id = '$eid' LIMIT 1");
	echo "<center><b>Серфер добавлен</b></center><BR />";
...
$string = ($type == "-") ? "У пользователя снято {$sum} ключей" : "Пользователю добавлено {$sum} ключей";
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Ключи (Покупки):</td>
    <td width="200" align="center"><?=sprintf("%.2f",$data["money_b"]); ?></td>
  </tr>
  
  <tr>
    <td style="padding-left:10px;">Ключи (Вывод):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Монет на балансе (Jake):</td>
    <td width="200" align="center"><?=$data["a_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Монет на балансе (Tricky):</td>
    <td width="200" align="center"><?=$data["b_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Монет на балансе (Fresh):</td>
    <td width="200" align="center"><?=$data["c_b"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Монет на балансе (Spike):</td>
    <td width="200" align="center"><?=$data["d_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Монет на балансе (Yutani):</td>
    <td width="200" align="center"><?=$data["e_b"]; ?></td>
  </tr>
  
  
  <tr>
    <td style="padding-left:10px;">Серферов (Jake):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серферов (Tricky):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Серферов (Fresh):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серферов (Spike):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">Серферов (Yutani):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серферов за все время (Jake):</td>
    <td width="200" align="center"><?=$data["all_time_a"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Серферов за все время (Tricky):</td>
    <td width="200" align="center"><?=$data["all_time_b"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серферов за все время (Fresh):</td>
    <td width="200" align="center"><?=$data["all_time_c"]; ?></td>
  </tr>
  <tr>
    <td style="padding-left:10px;">Серферов за все время (Spike):</td>
    <td width="200" align="center"><?=$data["all_time_d"]; ?></td>
  </tr>
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серферов за все время (Yutani):</td>
...
?>
<form action="/?menu=admin404&sel=users&search" method="post">
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  <tr bgcolor="#efefef">
    <td align="center" width="50" class="m-tb"><a href="/?menu=admin404&sel=users&sort=0" class="stn-sort">ID</a></td>
    <td align="center" class="m-tb"><a href="/?menu=admin404&sel=users&sort=1" class="stn-sort">User</a></td>
    <td align="center" width="90" class="m-tb"><a href="/?menu=admin404&sel=users&sort=2" class="stn-sort">Серебра</a></td>
	<td align="center" width="75" class="m-tb"><a href="/?menu=admin404&sel=users&sort=3" class="stn-sort">Серферов</a></td>
	<td align="center" width="100" class="m-tb"><a href="/?menu=admin404&sel=users&sort=4" class="stn-sort">Зарегистрирован</a></td>
  </tr>
...
<?PHP
    ...
    <td align="center"><a href="/?menu=admin404&sel=users&edit=<?=$data["id"]; ?>" class="stn"><?=$data["user"]; ?></a></td>
...
$all_pages = $db->FetchRow();
	...
	echo "<BR /><center>".$nav->Navigation(10, $page, ceil($all_pages / 100), "/?menu=admin404&sel=users&sort={$sort_b}&page="), "</center>";
