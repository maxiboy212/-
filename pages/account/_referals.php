...
?>  
<center>
<div class="silver-bk">Приглашайте в игру своих друзей и знакомых, Вы будете получать 10 серебра за каждого приглашенного реферала + 20% от каждого пополнения баланса  
...
<img src="/img/piar-link.png" style="vertical-align:-2px; margin-right:5px;" /><font color="#000;">http://<? echo htmlspecialchars($_SERVER['HTTP_HOST']); ?>/?i=<?=$_SESSION["user_id"]; ?></font>

<b>Банеры для превлечения рефералов: </b><br> <br></font>
