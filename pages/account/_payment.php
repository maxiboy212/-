...
<b>Из платежной системы Payeer Вы можете вывести свои средства в автоматическом режиме на все известные платежные системы и международные банки.</b><BR /><BR />
 - <a href="https://payeer.com/?partner=1115613" target="_blank">Создание счета в PAYEER</a> <BR />
						...
						if($db->FetchRow() == 0){
							...
							if ($payeer->isAuth())
							{
								...
								if($arBalance["auth_error"] == 0)
								{
									...
									'comment' => iconv('windows-1251', 'utf-8', "Выплата пользователю {$usname} с проекта Golden-Gnomes.pro")
