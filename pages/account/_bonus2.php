...
<div class="col-md-8">								<div class="s-bk-lf">
									<div class="title">БОНУС С РИСКОМ</div>
								</div>
								<div class="silver-bk">


<BR /><center>
Это бонус для любителей рисковать. Рискни и может быть ты получишь не плохой бонус:)
Бонус выдется 1 раз в 24 часа. 
...
<?PHP
	...
	}else echo "<center><font color = 'blue'><b>Вы уже получали бонус за последние 24 часa </b></font></center><BR />";  ?>  


<table class="table" align="center" border="0" cellpadding="3" cellspacing="0" width="99%">
  <tr>
    <td colspan="5" align="center"><h4>Последние 50 бонусов</h4></td>
    </tr>
  <tr>
