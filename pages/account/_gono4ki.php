...
Необходимо угадать какой автомобиль выиграет данную гонку!<BR />
При выигрыше ваша ставка увеличивается в 2 раза и зачисляется на баланс для покупок!
<BR /><BR /></center>
<center>
<?PHP
$_OPTIMIZATION["title"] = "Аккаунт - Гонки Автомобилей";
		...
		if($stavka <= $user_data['money_b']) {
			if($stavka >= 50) {
				if($naper == 1 or $naper ==  2 or $naper == 3) {
					...
					$sum = $stavka * 2;
					$win = 1;
						echo "<center><font color='green'>Поздравляем! Вы выиграли :) </font>";
				...
				}else echo "<center><font color='red'>Выберете Автомобиль!</font>";
			}else echo "<center><font color='red'>Минимальная ставка 100 серебра!</font>";
