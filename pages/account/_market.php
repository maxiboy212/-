...
?>
 ...
 <center>
<div class="silver-bk">Торговая лавка позволит вам продать все Ваши монеты за КЛЮЧИ, которые можно обменять на реальные деньги. Вырученное с продажи КЛЮЧИ распределяется между двумя счетами (счет для покупок и счет для вывода) в пропорциях: <?=100-$sonfig_site["percent_sell"]; ?>% на счет для покупок и <?=$sonfig_site["percent_sell"]; ?>% на вывод.<br /><br />
Курс продажи любых монет: <font color="white"><?=$sonfig_site["items_per_coin"]; ?> МОНЕТ = 1 КЛЮЧЕЙ.</font>
...
$all_items = $user_data["a_b"] + $user_data["b_b"] + $user_data["c_b"] + $user_data["d_b"] + $user_data["e_b"] + $user_data["f_b"];
	...
	if($all_items > 0){
		...
		echo "<center><font color = 'green'><b>Вы продали {$all_items} Монет, на сумму {$money_add} Ключей</b></font></center><BR />";
...
<table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td height="30" align="center" valign="middle"><strong>Получится ключей</strong></td>
  </tr>
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/birds/greenegg.png"></div></td>
  ...
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/birds/yellowegg.png"></div></td>
  ...
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/birds/brownegg.png"></div></td>
  ...
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/birds/blueegg.png"></td>
  ...
  <tr>
    <td width="30" height="30" align="center" valign="middle"><div class="sm-line-nt"><img src="/img/birds/redegg.png"></div></td>
