...
<b>Лотерея</b> - это такая игра :) Всего имеется <?=$num_bil; ?> билетов. <br>После того, как все билеты будут проданы состоится розыгрыш счастливых билетов. <br>Система случайным образом выберет 3 номера счастливых билетов и зачислит им призы. <BR /><BR />
...
<BR />
<br>
<center><a class="btn_acc" href="/account/lottery/winners">Список завершенных лотерей</a><br></center>
