...
<div class="col-md-8">								<div class="s-bk-lf">
									<div class="title">ОБМЕННИК КЛЮЧЕЙ</div>
								</div>
								<div class="silver-bk">
...
<center><div class="title">Обмен возможен только в одну сторону:</div></center>
 ...
 <center>
<div class="silver-bk">В обменном пункте Вы можете обменять КЛЮЧИ ДЛЯ ВЫВОДА на КЛЮЧИ ДЛЯ ПОКУПОК.<br> 
При обмене КЛЮЧЕЙ Вы получаете +30% на счет для покупок.<br><br>
<center><font color="white">Обмен возможен только в одну сторону</font><p></p></center>
</div>
...
<table width="400" border="0" align="center">
  <tr>
    <td><font color="#000;">Отдаете КЛЮЧЕЙ для вывода</font> [мин. 100]: </td>
    <td align="center"><input type="text" class="lg" name="sum" id="sum" value="100" onkeyup="GetSumPer();" style="margin:0px; width:60px;"/></td>
  </tr>
  <tr>
    <td><font color="#000;">Получаете КЛЮЧЕЙ для покупок</font> [+<?=$sonfig_site["percent_swap"]; ?>%]: </td>
